...
It's a command that is safe to use at any time. If you want to see what is going on it's godo to use `git status` in-between commands until you get to know the flow better.
